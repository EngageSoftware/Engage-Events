<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="MonthlyRecurrence.ascx.cs" Inherits="Engage.Dnn.Events.Recurrence.MonthlyRecurrence" %>

<asp:Panel ID="MonthlyRecurrencePanel" runat="server" CssClass="Normal">
