...
<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="ModuleMessage.ascx.cs" Inherits="Engage.Dnn.Events.Controls.ModuleMessage" EnableViewState="false" %>
<div class="<%=MessageStyle %>Message ModuleMessage">
        <div class="<%=MessageStyle %>Top"></div>
