...
<asp:Panel ID="weeklyPanel" runat="server" Height="129px" Style="left: 8px; top: 8px" Width="424px">
    ...
    <asp:Label ID="Label7" runat="server" Font-Names="Verdana" Font-Size="X-Small" Style="
        left: 136px; top: 8px">week(s)</asp:Label>
    <asp:Label ID="Label8" runat="server" Font-Names="Verdana" Font-Size="X-Small" Style="
